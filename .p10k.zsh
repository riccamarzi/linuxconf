# Generated by Powerlevel10k configuration wizard on 2025-06-23 at 17:06 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg.*|.*tun.*|tailscale.*|zt.*)'
  ...
  typeset -g POWERLEVEL9K_IP_INTERFACE='wlp5s0'
  # Custom icon.
